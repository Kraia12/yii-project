...
class MexStatesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['MexStates']))
		{
			$model->attributes=$_POST['MexStates'];
			if($model->save())
	...
	{
		$model=new MexStates('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MexStates']))
			$model->attributes=$_GET['MexStates'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mex-states-form')
		{
